...
package com.tlink.openapi.invoker;
...
import com.tlink.openapi.invoker.auth.Authentication;
import com.tlink.openapi.invoker.auth.HttpBasicAuth;
import com.tlink.openapi.invoker.auth.HttpBearerAuth;
import com.tlink.openapi.invoker.auth.ApiKeyAuth;
import com.tlink.openapi.invoker.auth.OAuth;
import com.tlink.openapi.invoker.auth.RetryingOAuth;
import com.tlink.openapi.invoker.auth.OAuthFlow;
...
public class ApiClient {
    ...
    protected String basePath = "http://127.0.0.1:8082";
    ...
    public ApiClient() {
        ...
        authentications.put("Authenticate", new OAuth());
        authentications.put("tlinkAppId", new ApiKeyAuth("header", "tlinkAppId"));
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = basePath + "/oauth/token";
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.0.0.RELEASE/java");
     ...
     * @return a {@link com.tlink.openapi.invoker.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.tlink.openapi.invoker.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.tlink.openapi.invoker.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.tlink.openapi.invoker.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.tlink.openapi.invoker.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.tlink.openapi.invoker.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.tlink.openapi.invoker.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.tlink.openapi.invoker.ApiException If fails to update the parameters
     */
     ...
     * @throws com.tlink.openapi.invoker.ApiException If fail to serialize the request body object into a string
     */
